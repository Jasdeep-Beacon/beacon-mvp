                                ...
                                <div className="billing-section">
                                    ...
                                    <div className="details-container">
                                        ...
                                        <ul className="points-list">
                                            ...
                                            <li>
                                                <i className="material-icons">done</i> <span>Tag important moments live , during user interviews</span>
                                            </li>

                                            <li><i className="material-icons">done</i> <span> Synthesize your researchacross Google docs</span>

                                            </li>

                                            <li><i className="material-icons">done</i> <span> Documents user insights quickly and efficiently </span>
                            ...
                            <div className="col-sm-12 center-form register-form">
                                ...
                                <form className="mt-5">
                                    ...
                                    <div className="col-sm-12 form-group">
                                        ...
                                        <input ref="email" type="text" placeholder="Your work email"
                                               className="form-control"/>
                                    ...
                                    <div className="col-sm-12 form-group">
                                        ...
                                        <button type="button" onClick={this.passDataToPaymentSection}
                                                disabled={registerIn} className="btn primary-btn">
                                            {
